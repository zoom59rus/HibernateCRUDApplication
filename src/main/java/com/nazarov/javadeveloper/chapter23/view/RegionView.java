package com.nazarov.javadeveloper.chapter23.view;

import com.nazarov.javadeveloper.chapter23.controllers.RegionController;
...
public class RegionView {
    ...
    public Region getRegion(String name) {
        return regionController.getByName(name);
    }
